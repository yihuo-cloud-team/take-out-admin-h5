  ...
  <div id="user">
    <div class="user-info">
      <div class="info-image">
        <img
          class="img"
          src="http://pic.51yuansu.com/pic3/cover/01/69/80/595f67c042c1b_610.jpg"
          alt
        />
      </div>
      <div class="user-name">{{name | nullToText}}</div>
      <div class="meal-box">
        <span class="tab">{{meal}}</span>
      </div>
    </div>
    <div class="security">
      ...
      <van-cell @click="$router.push('/notify')" title="消息通知" is-link />
      <van-cell @click="$router.push('/bind')" title="绑定微信" is-link />
    </div>
